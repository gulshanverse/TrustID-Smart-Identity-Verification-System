...
type Result = { correlation_summary: string; evidence: Evidence[]; findings: Finding[]; risk: { risk_score: number; risk_level: string; recommendation: string }; intelligence?: Intelligence };
